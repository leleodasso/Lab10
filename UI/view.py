...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        # ROW with controls es 2
        self._ddStato = ft.Dropdown(label="Stato")
        self._controller.fillddStato()
        self._btnRaggiungibili = ft.ElevatedButton(text="Stati Raggiungibili", on_click=self._controller.handleStatiRaggiungibili)
